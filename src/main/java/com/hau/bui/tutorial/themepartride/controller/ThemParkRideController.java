package com.hau.bui.tutorial.themepartride.controller;

import com.hau.bui.tutorial.themepartride.entity.ThemeParkRide;
import com.hau.bui.tutorial.themepartride.repository.ThemeParkRideRepository;
...
@RestController
public class ThemParkRideController {

    private final ThemeParkRideRepository themeParkRideRepository;

    public ThemParkRideController(ThemeParkRideRepository themeParkRideRepository) {
